...
from funnelboat.models import EngineRequest, EngineTrigger
from funnelboat.version import VERSION
...
class EngineClient:
    ...
    def __init__(
        ...
        self._headers: dict[str, str] = {
            ...
            "User-Agent": f"funnelboat-cli/{VERSION.app_version}",
        }
        self.verify_tls = requests_verify
        self.session = aiohttp.ClientSession(trace_configs=[PrometheusTraceConfig(client_name="engine-client")])
